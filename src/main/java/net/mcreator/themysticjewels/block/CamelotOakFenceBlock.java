...
public class CamelotOakFenceBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:camelot_oak_fence")
	public static final Block block = null;
	public CamelotOakFenceBlock(ThemysticjewelsModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("camelot_oak_fence");
		}
