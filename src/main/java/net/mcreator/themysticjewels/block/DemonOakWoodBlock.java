...
public class DemonOakWoodBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:demon_oak_wood")
	public static final Block block = null;
	public DemonOakWoodBlock(ThemysticjewelsModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("demon_oak_wood");
		}
