...
public class DimensionOakFenceGateBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:dimension_oak_fence_gate")
	public static final Block block = null;
	public DimensionOakFenceGateBlock(ThemysticjewelsModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dimension_oak_fence_gate");
		}
