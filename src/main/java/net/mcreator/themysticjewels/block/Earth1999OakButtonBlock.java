...
public class Earth1999OakButtonBlock extends ThemysticjewelsModElements.ModElement {

	@ObjectHolder("themysticjewels:earth_1999_oak_button")
	public static final Block block = null;

	public Earth1999OakButtonBlock(ThemysticjewelsModElements instance) {
		super(instance, 67);
	...
	public static class CustomBlock extends WoodButtonBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("earth_1999_oak_button");
		}
