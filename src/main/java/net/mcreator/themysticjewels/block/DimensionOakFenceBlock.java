...
public class DimensionOakFenceBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:dimension_oak_fence")
	public static final Block block = null;
	public DimensionOakFenceBlock(ThemysticjewelsModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dimension_oak_fence");
		}
