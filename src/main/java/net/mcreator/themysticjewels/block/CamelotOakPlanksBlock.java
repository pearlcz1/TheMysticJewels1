...
public class CamelotOakPlanksBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:camelot_oak_planks")
	public static final Block block = null;
	public CamelotOakPlanksBlock(ThemysticjewelsModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("camelot_oak_planks");
		}
