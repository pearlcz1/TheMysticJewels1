...
public class CamelotOakLogBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:camelot_oak_log")
	public static final Block block = null;
	public CamelotOakLogBlock(ThemysticjewelsModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("camelot_oak_log");
		}
