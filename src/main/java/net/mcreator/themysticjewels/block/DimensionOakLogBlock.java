...
public class DimensionOakLogBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:dimension_oak_log")
	public static final Block block = null;
	public DimensionOakLogBlock(ThemysticjewelsModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dimension_oak_log");
		}
