...
public class CamelotOakPressurePlateBlock extends ThemysticjewelsModElements.ModElement {

	@ObjectHolder("themysticjewels:camelot_oak_pressure_plate")
	public static final Block block = null;

	public CamelotOakPressurePlateBlock(ThemysticjewelsModElements instance) {
		super(instance, 46);
	...
	public static class CustomBlock extends PressurePlateBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("camelot_oak_pressure_plate");
		}
