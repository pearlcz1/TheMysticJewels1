...
public class CamelotOakWoodBlock extends ThemysticjewelsModElements.ModElement {

	@ObjectHolder("themysticjewels:camelot_oak_wood")
	public static final Block block = null;

	public CamelotOakWoodBlock(ThemysticjewelsModElements instance) {
		super(instance, 38);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("camelot_oak_wood");
		}
