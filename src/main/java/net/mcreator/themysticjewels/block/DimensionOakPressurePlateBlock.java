...
public class DimensionOakPressurePlateBlock extends ThemysticjewelsModElements.ModElement {

	@ObjectHolder("themysticjewels:dimension_oak_pressure_plate")
	public static final Block block = null;

	public DimensionOakPressurePlateBlock(ThemysticjewelsModElements instance) {
		super(instance, 86);
	...
	public static class CustomBlock extends PressurePlateBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("dimension_oak_pressure_plate");
		}
