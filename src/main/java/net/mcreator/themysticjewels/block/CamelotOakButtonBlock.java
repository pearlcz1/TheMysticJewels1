...
public class CamelotOakButtonBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:camelot_oak_button")
	public static final Block block = null;
	public CamelotOakButtonBlock(ThemysticjewelsModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("camelot_oak_button");
		}
