...
public class DemonOakLogBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:demon_oak_log")
	public static final Block block = null;
	public DemonOakLogBlock(ThemysticjewelsModElements instance) {
		super(instance, 15);
	}
