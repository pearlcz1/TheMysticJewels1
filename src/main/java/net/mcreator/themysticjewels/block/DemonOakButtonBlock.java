...
public class DemonOakButtonBlock extends ThemysticjewelsModElements.ModElement {

	@ObjectHolder("themysticjewels:demon_oak_button")
	public static final Block block = null;

	public DemonOakButtonBlock(ThemysticjewelsModElements instance) {
		super(instance, 23);
	...
	public static class CustomBlock extends WoodButtonBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("demon_oak_button");
		}
