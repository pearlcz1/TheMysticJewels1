...
public class DimensionOakStairsBlock extends ThemysticjewelsModElements.ModElement {

	@ObjectHolder("themysticjewels:dimension_oak_stairs")
	public static final Block block = null;

	public DimensionOakStairsBlock(ThemysticjewelsModElements instance) {
		super(instance, 82);
	...
	public static class CustomBlock extends StairsBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("dimension_oak_stairs");
		}
