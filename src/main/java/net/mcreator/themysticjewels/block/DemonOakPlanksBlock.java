...
public class DemonOakPlanksBlock extends ThemysticjewelsModElements.ModElement {

	@ObjectHolder("themysticjewels:demon_oak_planks")
	public static final Block block = null;

	public DemonOakPlanksBlock(ThemysticjewelsModElements instance) {
		super(instance, 16);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("demon_oak_planks");
		}
