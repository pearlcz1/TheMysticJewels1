...
public class DemonOakFenceBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:demon_oak_fence")
	public static final Block block = null;
	public DemonOakFenceBlock(ThemysticjewelsModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("demon_oak_fence");
		}
