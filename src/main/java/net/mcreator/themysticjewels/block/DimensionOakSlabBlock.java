...
public class DimensionOakSlabBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:dimension_oak_slab")
	public static final Block block = null;
	public DimensionOakSlabBlock(ThemysticjewelsModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dimension_oak_slab");
		}
