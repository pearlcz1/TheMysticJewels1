...
public class DimensionOakButtonBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:dimension_oak_button")
	public static final Block block = null;
	public DimensionOakButtonBlock(ThemysticjewelsModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("dimension_oak_button");
		}
