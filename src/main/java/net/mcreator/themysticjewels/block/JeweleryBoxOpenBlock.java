...
public class JeweleryBoxOpenBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:jewelery_box_open")
	public static final Block block = null;
	public JeweleryBoxOpenBlock(ThemysticjewelsModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jewelery_box_open");
		}
