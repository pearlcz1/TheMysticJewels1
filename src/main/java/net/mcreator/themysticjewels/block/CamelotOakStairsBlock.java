...
public class CamelotOakStairsBlock extends ThemysticjewelsModElements.ModElement {
	@ObjectHolder("themysticjewels:camelot_oak_stairs")
	public static final Block block = null;
	public CamelotOakStairsBlock(ThemysticjewelsModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("camelot_oak_stairs");
		}
